      ...
      <div className="portfolio" >
        <div>
          <div className=" small_image_card">
            <img src="/images/RangerRoverAutoBiographt.png" alt="portfolio image" />
            <h3 className="poppins black portfolio_title">Ranger Rover Auto Biographt(Available)</h3>
          ...
          <div className=" big_image_card">
            ...
            <h3 className="poppins black portfolio_title">BMW 6 Series(Available)</h3>
            <button className="buy_now poppins">Buy Now</button>
          </div>
        </div>
        <div>
          <div className=" big_image_card">
            ...
            <h3 className="poppins black portfolio_title">Mercedes Benz 2022(Available)</h3>
            <button className="buy_now poppins">Buy Now</button>
          </div>
          <div className=" small_image_card">
            <img src="/images/Jaguar.png" alt="portfolio image" />
            <h3 className="poppins black portfolio_title">Jaguar(Available)</h3>
            <button className="buy_now poppins">Buy Now</button>
          </div>
        </div>
      </div>
